...
public class Thi extends JPanel implements ActionListener, MouseListener {
	...
	public void window(int width, int height, Thi game){ //draw the frame and add exit functionality
